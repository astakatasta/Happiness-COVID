...
mean_2015_2020 = left_join(mean_2015_2020, continents, by = "Country")
...
## Andamento della felicità dopo il COVID-19 (2021-2022)

``` {r}
df_2021_2022 = df_union %>% filter(Year > 2020) %>% drop_na()

mean_2021_2022 = df_2021_2022 %>% group_by(Country) %>% summarise(Mean = mean(Score))

mean_2021_2022 = left_join(mean_2021_2022, continents, by = "Country")

mean_2021_2022 = mean_2021_2022[!duplicated(mean_2021_2022),]
...
mean_2021_2022 %>% 
  ...
  scale_fill_viridis_c(begin = 0, end = 0, option = "turbo") +
  guides(fill = "none") +
  labs(title = "Top 20 stati con punteggio di felicità più elevato (2021-2022)",
       x = "",
       y = "") +
  geom_text(aes(label = round(Mean, 2)),
            color = "white",
            ...
            size = 3)
``` 
Gli stati più felici sono del nord Europa, l'Africa non ha stati in cima e l'Asia solo Israele.
